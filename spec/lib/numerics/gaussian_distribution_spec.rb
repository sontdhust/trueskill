...
describe Numerics::GaussianDistribution, "absolute difference (-)" do
  ...
  it "should be 130.399408 for (22, 0.4) - (12, 1.3)" do
    expect(Numerics::GaussianDistribution.new(22, 0.4) - Numerics::GaussianDistribution.new(12, 1.3)).
      to be_within(tolerance).of(130.399408)
  end
end
...
describe Numerics::GaussianDistribution, "multiplication (*)" do
  ...
  it "should have a mean of 0.2" do
    expect((Numerics::GaussianDistribution.new(0, 1) * Numerics::GaussianDistribution.new(2, 3)).mean).
      to be_within(0.00001).of(0.2)
  end

  it "should have a standard_deviation of 3.0 / Math.sqrt(10)" do
    expect((Numerics::GaussianDistribution.new(0, 1) * Numerics::GaussianDistribution.new(2, 3)).standard_deviation).
      to be_within(0.00001).of(3.0 / Math.sqrt(10))
  end
end
...
describe Numerics::GaussianDistribution, "#log_product_normalization" do
  ...
  it "should have calculate -3.0979981" do
    lp = Numerics::GaussianDistribution.
      log_product_normalization(Numerics::GaussianDistribution.new(4, 5), Numerics::GaussianDistribution.new(6, 7))
